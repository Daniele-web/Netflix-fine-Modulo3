const filmList = [
    ...
    {Title:"Afterlife" ,Genere:["Comedy", "TvShow", "NewUpdate", "Guarda di nuovo", "Visto"], img:"./assets/imgs/movies/2.png"},
    ...
    {Title:"Virgin River" ,Genere:["Drama", "TvShow", "Guarda di nuovo", "Visto"], img:"./assets/imgs/movies/8.png"},
    {Title:"The english game" ,Genere:["Drama", "Movie", "Guarda di nuovo", "Visto"], img:"./assets/imgs/movies/9.png"},
    {Title:"Il metodo Kominsky" ,Genere:["Comedy", "Movie", "Guarda di nuovo", "Visto"], img:"./assets/imgs/movies/10.png"},
    ...
    {Title:"Selfe-Made" ,Genere:["Drama", "TvShow", "Guarda di nuovo", "Visto"], img:"./assets/imgs/movies/14.png"},
    ...
    {Title:"Lasciati andare" ,Genere:["Comedy", "Movie", "Guarda di nuovo", "Visto"], img:"./assets/imgs/movies/17.png"},
